      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.p 
              className="text-xl md:text-2xl mb-6 text-primary-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div 
              className="flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
