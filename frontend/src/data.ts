...
import { Experience, Skill, UserData, Project } from './types';
...
export const experienceData: Experience[] = [
  {
    ...
    date: "2022 - Present",
    description: "Leading product development for agent orchestration systems and AI-powered automation tools.",
    icon: Brain,
    achievements: [
    ...
    projects: [
      {
        name: "Eko Framework",
        description: "Developed a comprehensive framework for building computer use agents with natural language interfaces"
      },
      {
        name: "Agent Collaboration System",
        description: "Created a system allowing multiple specialized AI agents to collaborate on complex tasks"
      },
      {
        name: "Multimodal Reasoning Pipeline",
        description: "Built a pipeline for processing and reasoning about multimodal inputs (text, images, code)"
      }
    ]
  },
  {
    ...
    description: "Led product strategy and development for enterprise feedback and analytics solutions.",
    icon: Briefcase,
    achievements: [
    ...
    projects: [
      {
        ...
        description: "Complete redesign of the enterprise platform with self-service capabilities and improved UX"
      },
      {
        name: "Feedback Intelligence",
        description: "AI-powered system for analyzing customer feedback and generating actionable insights"
      }
    ]
  },
  {
    ...
    description: "Defined roadmap and strategy for healthcare management product lines worth $40M annually.",
    icon: Building2,
    achievements: [
    ...
    projects: [
      {
        ...
        description: "Redesigned patient portal with improved accessibility and mobile responsiveness"
      },
      {
        name: "Provider Communication Suite",
        description: "Secure messaging and collaboration tools for healthcare providers"
      }
    ]
  },
  {
    ...
    date: "2011 - 2015",
    description: "Defined digital product requirements and functional specifications with business partners.",
    icon: Award,
    achievements: [
    ...
    projects: [
      {
        ...
        description: "First-generation mobile banking application with secure transaction capabilities"
      },
      {
        name: "Remote Deposit Capture",
        description: "Feature allowing customers to deposit checks using their smartphone cameras"
      }
    ]
  },
  {
    ...
    location: "Cincinnati, Ohio",
    date: "2009 - 2011",
    description: "Completed 2-year leadership rotational program across multiple IT disciplines.",
    icon: GraduationCap,
    achievements: [
    ...
    projects: [
      {
        ...
        description: "Contributed to the long-term digital banking strategy and implementation roadmap"
      },
      {
        name: "Online Banking Redesign",
        description: "Assisted with requirements gathering and user testing for online banking platform"
      }
    ]
  }
];
...
export const userData: UserData = {
  ...
  bioLine: "AI Product Manager - Agent Orchestrator",
